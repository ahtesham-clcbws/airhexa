...
<li class="<?= $_SERVER['REQUEST_URI'] === route_to('plumbingSystemService') ? 'active' : '' ?>">
    <a href="<?= route_to('plumbingSystemService') ?>">Plumbing & Drainage Systems</a>
</li>
...
<li class="<?= $_SERVER['REQUEST_URI'] === route_to('electricalSystemsService') ? 'active' : '' ?>">
    <a href="<?= route_to('electricalSystemsService') ?>">Electrical System (low current)</a>
</li>
<li class="<?= $_SERVER['REQUEST_URI'] === route_to('solarSystemService') ? 'active' : '' ?>">
    <a href="<?= route_to('solarSystemService') ?>">Industrial Ventilation</a>
</li>
