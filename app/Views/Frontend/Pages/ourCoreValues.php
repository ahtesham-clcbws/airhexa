...
<!-- breadcrumb-area -->
<?= view('Components/WebServicesBreadcrumb', ['serviceName' => 'Our Core Values', 'imageUrl' => '/img/ourCoreValues.jpg']); ?>
<!-- breadcrumb-area-end -->
<!-- about-area -->
<section id="about" class="about-area about-p pt-95 pb-95 p-relative" style="background-image:url(/img/bg/about_aliment_bg.png); background-size: cover; background-repeat: no-repeat;background-position: center center;">
    <div class="container">
            ...
            <div class="col">
                <div class="about-content s-about-content pl-30">
                    <div class="about-title second-atitle">
                        ...
                        Our core values are translated into every aspect of our business.
                        </p>
                        <ul class="listStyleBullet">
                            <li><b>Integrity:</b> <span class="mainColor2">We can trust and rely on each other</span> | Integrity is a guiding principle in our business interactions. 
                                Respecting the trust of our customers and employees is an unconditional obligation. We stand by our word and take responsibility 
                                for every decision we make.</li>
                                <li><b>Quality:</b> <span class="mainColor2">We always strive for the best</span> | Providing optimal quality services is a must. Our goal is not to 
                                meet customer expectations. Our goal is to surpass them.</li>                            
                                <li><b>Human Capital:</b><span class="mainColor2"> We believe in our team</span> | Our most valuable asset is our team. We value a culture of
                                 learning and develop the potential of our employees.</li>                            
                                <li><b>Innovation:</b> <span class="mainColor2"> We will always find a way</span> | Our company strives to continuously come up with solutions that create value for customers. 
                                We empower employees and embrace innovative developments in all our business processes. .</li>                            
                                <li><b>Sustainability:</b> <span class="mainColor2">We respect our environment and community</span> | Our company cares about the environment. Saving valuable resources is one of our many environmentally friendly strategies
                                . Maintaining sustainable operations is also part of our strategy to continue serving our community for many generations to come. </li>
                        </ul>
