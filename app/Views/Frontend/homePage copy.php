...
<!-- about-area -->
<section id="about" class="about-area about-p pt-100 pb-95 p-relative" style="background-image:url(/img/bg/about_aliment_bg.png); background-size: contain; background-repeat: no-repeat;background-position: center center;">
    <div class="container">
...
<!-- counter-area -->
<div class="counter-area" style="background-image:url(/img/count/count-bg.jpg); background-repeat: no-repeat; background-position: bottom;">
    <div class="container">
...
<!-- services-area -->
<section id="services" class="services-area services-bg services-two pt-95 pb-70" style="background-image:url(/img/bg/services_aliment_bg.png); background-size: contain; background-repeat: no-repeat;background-position: center center;">
    <div class="container">
            ...
            <div class="col-xl-10 col-lg-10">
                <div class="section-title text-center pl-40 pr-40 mb-80 wow fadeInDown animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <span><small class="circle-left"><img src="/img/bg/circle_Left.png" alt="img"></small> our
                        services <small class="circle-right"><img src="/img/bg/circle_right.png" alt="img"></small></span>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services active wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/1.svg" alt="img" class="d-active-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/2.svg" alt="img" class="d-active-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/3.svg" alt="img" class="d-active-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/4.svg" alt="img" class="d-active-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/5.svg" alt="img" class="d-active-icon">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="s-single-services wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <div class="services-icon">
                        <img src="/img/services/6.svg" alt="img" class="d-active-icon">
...
<!-- cta-area -->
<section class="cta-area cta-bg pt-95 pb-70 mt-60" style="background-image:url(/img/bg/how_it_bg.png); background-size: cover;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="section-title center-align mb-40 wow fadeInDown animated text-center" data-animation="fadeInDown animated" data-delay=".2s">
                    <span><small class="circle-left"><img src="/img/bg/circle_Left.png" alt="img"></small>
                        Testimonial <small class="circle-right"><img src="/img/bg/circle_right.png" alt="img"></small></span>
                ...
                <div class="testimonial-active2">
                    ...
                    <div class="slider slider-for">
                        <div class="single-testimonial">
                            ...
                            <p>“Phasellus ut consequat elit. Donec dapibus, dolor ac mollis mollis, sapien lorem
                                gravida magna, eu ullamcorper mi lectus a tortor. Aenean elementum tortor a sem
                                pharetra, in accumsan odio commodo. Nam ultricies ut enim nec accumsan. Vivamus
                                vel nunc eu diam fringilla bibendum laoreet eget felis. Praesent justo mauris,
                                tincidunt vitae nisi ultricies, condimentum finibus quam. Aenean sed velit
                                nulla. Etiam viverra scelerisque porta. Quisque ut dolor aliquam, gravida lacus
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="com-icon"><img src="/img/bg/Icon_comment.png" alt="img"></div>
                            <p>“Nam liber tempor cum soluta nobis eleifend option congue is nihil imper per tem
                                por legere me doming vulputate velit esse molestiesoluta nobis eleifend option
                                congue is nihil imper per tem por legere me doming vulputate velit esse
                                molestiesoluta nobis eleifend option congue is nihil imper .</p>
                            <div class="testi-author">
                                <img src="/img/testimonial/test_img01.png" alt="img">
                                <div class="ta-info">
                                    <h6>Mr Jone Dose</h6>
...
<!-- counter-area -->
<div class="call-area" style="background-image:url(/img/call/call-bg.png); background-repeat: no-repeat; background-position: bottom;">
    <div class="container">
        <div class="row align-items-center">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
                <div class="section-title text-center mb-80 wow fadeInDown animated" data-animation="fadeInDown animated" data-delay=".2s">
                    <span><small class="circle-left"><img src="/img/bg/circle_Left.png" alt="img"></small> OUR
                        LATEST BOLG <small class="circle-right"><img src="/img/bg/circle_right.png" alt="img"></small></span>
